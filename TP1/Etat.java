...
public class Etat implements Comparable<Etat> {
    ...
    public Collection<Successeur> enumererEtatsSuccesseurs() {
        ...
        // emplacement voisin,
        // ----> Ramasser un Colis lorsque le Van se trouve sur un emplacement de Colis
        // pas encore transporté
        // ----> Decharger un Colis lorsque le Van se trouve une un emplacement
        // d'arrivee
